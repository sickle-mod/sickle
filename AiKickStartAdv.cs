	...
	default:
		...
		private void CrimeaInnovative(SortedList<int, AiRecipe> actionOptions, AiPlayer player)
		{
			...
			case 0:
				...
				return;
			case 1:
				actionOptions.Add(int.MaxValue, new AiRecipe(player.AiTopActions[GainType.AnyResource], "Crimea Innovative Kickstart: Trade 2 Food")
				{
					tradeResource = new ResourceType[] { ResourceType.food, ResourceType.food }
				});
				return;
			case 2:
				actionOptions.Add(int.MaxValue, new AiRecipe(player.AiTopActions[GainType.Move], "Crimea Innovative Kickstart: Move worker [3,8]->[3,7], character->[3,7]")
				{
					moveAction = delegate(AiRecipe recipe, AiPlayer aiPlayer)
					{
						GainMove gainMove = (GainMove)player.AiTopActions[GainType.Move].GetTopGainAction();
				...
				return;
			case 3:
				actionOptions.Add(int.MaxValue, new AiRecipe(player.AiTopActions[GainType.AnyResource], "Crimea Innovative Kickstart: Trade 2 Oil")
				{
					tradeResource = new ResourceType[] { ResourceType.oil, ResourceType.oil }
				});
				return;
			...
			case 5:
				...
				return;
			case 6:
				actionOptions.Add(int.MaxValue, new AiRecipe(player.AiTopActions[GainType.Move], "Crimea Innovative Kickstart: expansion move")
				{
					moveAction = delegate(AiRecipe recipe, AiPlayer aiPlayer)
					{
						GainMove gainMove = (GainMove)player.AiTopActions[GainType.Move].GetTopGainAction();
						...
						// Move 1 worker from [3,8] to [3,7]
						if (hex38.GetOwnerWorkers().Count > 0)
						{
							this.gameManager.moveManager.SelectUnit(hex38.GetOwnerWorkers()[0]);
							this.gameManager.moveManager.MoveSelectedUnit(hex37, this.HexResources(hex38), null);
						}
						// Move 1 worker from [3,8] to [4,7]
						if (hex38.GetOwnerWorkers().Count > 1) // Using 2nd worker if available
						{
							this.gameManager.moveManager.SelectUnit(hex38.GetOwnerWorkers()[1]);
							this.gameManager.moveManager.MoveSelectedUnit(hex47, this.HexResources(hex38), null);
						}
						// Move character to [4,7]
						this.gameManager.moveManager.SelectUnit(player.player.character);
						this.gameManager.moveManager.MoveSelectedUnit(hex47, null, null);
			...
			case 8:
				...
				actionOptions.Add(int.MaxValue, new AiRecipe(player.AiTopActions[GainType.Power], "Crimea Innovative Kickstart: Bolster / Build Mill"));
				return;
			case 9:
				player.strategicAnalysis.preferredDeployPosition = this.gameManager.gameBoard.hexMap[4, 7];
				actionOptions.Add(int.MaxValue, new AiRecipe(player.AiTopActions[GainType.Produce], "Crimea Innovative Kickstart: Produce / Deploy"));
				return;
			case 10:
				player.strategicAnalysis.preferredBuildPosition = this.gameManager.gameBoard.hexMap[4, 7];
				actionOptions.Add(int.MaxValue, new AiRecipe(player.AiTopActions[GainType.Power], "Crimea Innovative Kickstart: Bolster / Build Mine"));
				return;
			default:
				return;
			}
