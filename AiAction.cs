...
namespace Scythe.GameLogic
{
    ...
    public class AiAction
    {
        ...
        // Token: 0x06002C7E RID: 11390 RVA: 0x00027EF0 File Offset: 0x000260F0
        public void GainCombatCard(AiRecipe recipe, AiPlayer player)
        {
            ...
            // Set the amount of cards to gain (typically just the full amount available)
            gainCombatCard.SetCards(gainCombatCard.Amount);
            this.gameManager.actionManager.PrepareNextAction();
        }

        // Token: 0x06002C7F RID: 11391 RVA: 0x000F7168 File Offset: 0x000F5368
        ...
        {
            // CRITICAL: Never take resources into combat (enemy-occupied hexes)
            foreach (GameHex gameHex in target)
            {
                if (gameHex.Owner != null && gameHex.Owner != unit.Owner)
                {
                    // This is an enemy hex - don't take resources into combat
                    return false;
                }
            }
            
            // Original logic for non-combat moves
        ...
        // Token: 0x06002C89 RID: 11401 RVA: 0x000F7CB4 File Offset: 0x000F5EB4
        ...
        // Token: 0x06002C8A RID: 11402 RVA: 0x000F823C File Offset: 0x000F643C
        ...
        // Token: 0x06002C8C RID: 11404 RVA: 0x000F844C File Offset: 0x000F664C
        ...
        // Token: 0x06002C8D RID: 11405 RVA: 0x000F8D78 File Offset: 0x000F6F78
        ...
        // Token: 0x06002C8E RID: 11406 RVA: 0x000F8E28 File Offset: 0x000F7028
        ...
        // Token: 0x06002C8F RID: 11407 RVA: 0x000F8F80 File Offset: 0x000F7180
        ...
        // Token: 0x06002C90 RID: 11408 RVA: 0x000F914C File Offset: 0x000F734C
        ...
        // Token: 0x06002C92 RID: 11410 RVA: 0x000F92F0 File Offset: 0x000F74F0
