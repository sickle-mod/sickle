...
namespace Scythe.GameLogic
{
	...
	public class ChallengeLogic1
	{
		// Token: 0x06002BEE RID: 11246 RVA: 0x000F39C0 File Offset: 0x000F1BC0
		public void InitChallenge1(GameManager gameManager)
		{
			gameManager.InitMap();
			...
			player2.GainStar(StarType.Objective);
			player2.GainStar(StarType.Workers);
			player2.GainStar(StarType.Structures);
