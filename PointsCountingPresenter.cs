...
namespace Scythe.UI
{
	...
	{
		// Token: 0x06001B82 RID: 7042 RVA: 0x000ACAFC File Offset: 0x000AACFC
		...
		// Token: 0x06001B83 RID: 7043 RVA: 0x000ACCC0 File Offset: 0x000AAEC0
		...
		// Token: 0x06001B84 RID: 7044 RVA: 0x000AD128 File Offset: 0x000AB328
		public void Cleanup()
		{
		...
		// Token: 0x06001B85 RID: 7045 RVA: 0x000AD1A4 File Offset: 0x000AB3A4
		...
		// Token: 0x06001B86 RID: 7046 RVA: 0x000AD388 File Offset: 0x000AB588
		...
		// Token: 0x06001B87 RID: 7047 RVA: 0x000AD3E0 File Offset: 0x000AB5E0
		...
		// Token: 0x06001B88 RID: 7048 RVA: 0x000AD520 File Offset: 0x000AB720
		...
		// Token: 0x06001B89 RID: 7049 RVA: 0x000AD7C4 File Offset: 0x000AB9C4
		...
		// Token: 0x06001B8A RID: 7050 RVA: 0x000AD900 File Offset: 0x000ABB00
		private void CountPopularity()
		{
			int i;
			Func<PlayerEndGameStats, bool> __9__0;
			int j;
			for (i = 0; i < this.enabledLogos.Count; i = j + 1)
			{
				...
				if ((func = __9__0) == null)
				{
					func = (__9__0 = (PlayerEndGameStats x) => x.player.matFaction.faction == this.enabledLogos[i].faction);
				}
		...
		// Token: 0x06001B8B RID: 7051 RVA: 0x000ADA2C File Offset: 0x000ABC2C
		private void AnimateStarsScore()
		{
			PointsCountingPresenter.__c__DisplayClass68_0 CS___8__locals1 = new PointsCountingPresenter.__c__DisplayClass68_0();
			CS___8__locals1.__4__this = this;
			this.isShowingScores = true;
			CS___8__locals1.i = 0;
			while (CS___8__locals1.i < this.enabledLogos.Count)
			{
				PointsCountingPresenter.__c__DisplayClass68_1 CS___8__locals2 = new PointsCountingPresenter.__c__DisplayClass68_1();
				CS___8__locals2.CS___8__locals1 = CS___8__locals1;
				CS___8__locals2.i1 = CS___8__locals2.CS___8__locals1.i;
				PointsCountingPresenter.__c__DisplayClass68_1 CS___8__locals3 = CS___8__locals2;
				IEnumerable<PlayerEndGameStats> enumerable = this.stats;
				Func<PlayerEndGameStats, bool> func;
				if ((func = CS___8__locals2.CS___8__locals1.__9__0) == null)
				{
					func = (CS___8__locals2.CS___8__locals1.__9__0 = (PlayerEndGameStats x) => x.player.matFaction.faction == CS___8__locals2.CS___8__locals1.__4__this.enabledLogos[CS___8__locals2.CS___8__locals1.i].faction);
				}
				CS___8__locals3.statsPlayer = enumerable.First(func);
				this.ChangeMultiplier(this.enabledLogos[CS___8__locals2.CS___8__locals1.i].multiplierText, PopularityTrack.StarsMultiplier(CS___8__locals2.statsPlayer.player.Popularity));
				this.enabledLogos[CS___8__locals2.i1].popularityText.DOFade(0f, this.popularityValueDisappearTime);
				Sequence sequence = DOTween.Sequence();
				sequence.AppendInterval(this.popularityGateChangeMultiplierTime * 1.2f);
				for (int i = this.enabledLogos[CS___8__locals2.CS___8__locals1.i].Stars.Count - 1; i >= 0; i--)
				{
					GameObject gameObject = this.enabledLogos[CS___8__locals2.CS___8__locals1.i].Stars[i];
					Sequence sequence2 = sequence.Append(gameObject.transform.DOScale(1.1f, 0.2f * this.starDisappearTime));
					TweenCallback tweenCallback;
					if ((tweenCallback = CS___8__locals2.__9__1) == null)
					{
						tweenCallback = (CS___8__locals2.__9__1 = delegate
						{
							CS___8__locals2.CS___8__locals1.__4__this.AddPointsToScore(CS___8__locals2.i1, PopularityTrack.StarsMultiplier(CS___8__locals2.statsPlayer.player.Popularity), true);
						});
					}
				...
				if (CS___8__locals2.statsPlayer.player.GetNumberOfStars() == 6 || ((GameController.Instance.GameFinishedTimeOut || MultiplayerController.Instance.SpectatorMode) && CS___8__locals2.CS___8__locals1.i == 0))
				{
					sequence.AppendCallback(new TweenCallback(this.AnimateHexScoring));
				}
				int i2 = CS___8__locals1.i;
				CS___8__locals1.i = i2 + 1;
			}
		}

		// Token: 0x06001B8C RID: 7052 RVA: 0x000ADC94 File Offset: 0x000ABE94
		private void AnimateHexScoring()
		{
			PointsCountingPresenter.__c__DisplayClass69_0 CS___8__locals1 = new PointsCountingPresenter.__c__DisplayClass69_0();
			CS___8__locals1.__4__this = this;
			...
			while (CS___8__locals1.i < this.enabledLogos.Count)
			{
				PointsCountingPresenter.__c__DisplayClass69_1 CS___8__locals2 = new PointsCountingPresenter.__c__DisplayClass69_1();
				CS___8__locals2.CS___8__locals1 = CS___8__locals1;
				CS___8__locals2.i1 = CS___8__locals2.CS___8__locals1.i;
				EndPointsCountingElement endPointsCountingElement = this.enabledLogos[CS___8__locals2.CS___8__locals1.i];
				CS___8__locals2.hexText = endPointsCountingElement.hexCounter.GetComponentInChildren<Text>();
				CS___8__locals2.hexText.text = "0";
				PointsCountingPresenter.__c__DisplayClass69_1 CS___8__locals3 = CS___8__locals2;
				IEnumerable<PlayerEndGameStats> enumerable = this.stats;
				Func<PlayerEndGameStats, bool> func;
				if ((func = CS___8__locals2.CS___8__locals1.__9__1) == null)
				{
					func = (CS___8__locals2.CS___8__locals1.__9__1 = (PlayerEndGameStats x) => x.player.matFaction.faction == CS___8__locals2.CS___8__locals1.__4__this.enabledLogos[CS___8__locals2.CS___8__locals1.i].faction);
				}
				CS___8__locals3.statsPlayer = enumerable.First(func);
				...
				this.ChangeMultiplier(this.enabledLogos[CS___8__locals2.CS___8__locals1.i].multiplierText, PopularityTrack.TerritoryMultiplier(CS___8__locals2.statsPlayer.player.Popularity));
				Sequence sequence = DOTween.Sequence();
				sequence.Append(endPointsCountingElement.hexCounter.transform.DOScaleY(1f, this.restScoringAppearTime));
				int num2 = CS___8__locals2.statsPlayer.territoryPoints / PopularityTrack.TerritoryMultiplier(CS___8__locals2.statsPlayer.player.Popularity);
				CS___8__locals2.hexText.text = num2.ToString();
				for (int i = num2 - 1; i >= 0; i--)
				{
					...
					{
						CS___8__locals2.hexText.text = j1.ToString();
						CS___8__locals2.CS___8__locals1.__4__this.AddPointsToScore(CS___8__locals2.i1, PopularityTrack.TerritoryMultiplier(CS___8__locals2.statsPlayer.player.Popularity), true);
					});
					if (i == 0)
					{
				...
				if (CS___8__locals2.statsPlayer.territoryPoints == num && !flag)
				{
					flag = true;
		...
		// Token: 0x06001B8D RID: 7053 RVA: 0x000ADF60 File Offset: 0x000AC160
		private void AnimateResourcesScoring()
		{
			PointsCountingPresenter.__c__DisplayClass70_0 CS___8__locals1 = new PointsCountingPresenter.__c__DisplayClass70_0();
			CS___8__locals1.__4__this = this;
			...
			while (CS___8__locals1.i < this.enabledLogos.Count)
			{
				PointsCountingPresenter.__c__DisplayClass70_1 CS___8__locals2 = new PointsCountingPresenter.__c__DisplayClass70_1();
				CS___8__locals2.CS___8__locals1 = CS___8__locals1;
				CS___8__locals2.i1 = CS___8__locals2.CS___8__locals1.i;
				EndPointsCountingElement endPointsCountingElement = this.enabledLogos[CS___8__locals2.CS___8__locals1.i];
				CS___8__locals2.resourcesText = endPointsCountingElement.resourcesCounter.GetComponentInChildren<Text>();
				CS___8__locals2.resourcesText.text = "0";
				PointsCountingPresenter.__c__DisplayClass70_1 CS___8__locals3 = CS___8__locals2;
				IEnumerable<PlayerEndGameStats> enumerable = this.stats;
				Func<PlayerEndGameStats, bool> func;
				if ((func = CS___8__locals2.CS___8__locals1.__9__1) == null)
				{
				...
				this.ChangeMultiplier(this.enabledLogos[CS___8__locals2.CS___8__locals1.i].multiplierText, PopularityTrack.ResourceMultiplier(CS___8__locals2.statsPlayer.player.Popularity));
				Sequence sequence = DOTween.Sequence();
				sequence.Append(endPointsCountingElement.resourcesCounter.transform.DOScaleY(1f, this.restScoringAppearTime));
				int num2 = CS___8__locals2.statsPlayer.resourcePoints / PopularityTrack.ResourceMultiplier(CS___8__locals2.statsPlayer.player.Popularity);
				CS___8__locals2.resourcesText.text = num2.ToString();
				for (int i = num2 - 1; i >= 0; i--)
				{
					sequence.AppendInterval((i == num2) ? this.restScoringFirstHold : this.restScoringDelay);
					int j1 = i;
					sequence.AppendCallback(delegate
					{
						CS___8__locals2.resourcesText.text = j1.ToString();
						CS___8__locals2.CS___8__locals1.__4__this.AddPointsToScore(CS___8__locals2.i1, PopularityTrack.ResourceMultiplier(CS___8__locals2.statsPlayer.player.Popularity), true);
					});
					if (i == 0)
					{
						sequence.AppendInterval(this.restScoringLastHold);
				...
				if (CS___8__locals2.statsPlayer.resourcePoints == num && !flag)
				{
					flag = true;
					for (int j = 0; j < this.enabledLogos.Count; j++)
					{
		...
		// Token: 0x06001B8E RID: 7054 RVA: 0x000AE298 File Offset: 0x000AC498
		private void AnimateStructuresScoring()
		{
			int num = this.stats.Max((PlayerEndGameStats x) => x.structurePoints);
			bool flag = false;
			int i;
			Func<PlayerEndGameStats, bool> __9__1;
			int i2;
			for (i = 0; i < this.enabledLogos.Count; i = i2 + 1)
			{
				...
				if ((func = __9__1) == null)
				{
					func = (__9__1 = (PlayerEndGameStats x) => x.player.matFaction.faction == this.enabledLogos[i].faction);
				}
				PlayerEndGameStats playerEndGameStats = enumerable.First(func);
		...
		// Token: 0x06001B8F RID: 7055 RVA: 0x000AE514 File Offset: 0x000AC714
		...
		// Token: 0x06001B90 RID: 7056 RVA: 0x000AE790 File Offset: 0x000AC990
		private void AnimateFlagsScoring()
		{
			PointsCountingPresenter.__c__DisplayClass73_0 CS___8__locals1 = new PointsCountingPresenter.__c__DisplayClass73_0();
			CS___8__locals1.__4__this = this;
			...
			bool flag = false;
			CS___8__locals1.value = 0;
			int i;
			int l;
			for (i = 0; i < this.enabledLogos.Count; i = l + 1)
			{
				if (this.stats.First((PlayerEndGameStats x) => x.player.matFaction.faction == CS___8__locals1.__4__this.enabledLogos[i].faction).player.matFaction.faction == Faction.Albion)
				{
					CS___8__locals1.value = i;
					break;
				}
				l = i;
			}
			CS___8__locals1.i1 = CS___8__locals1.value;
			EndPointsCountingElement endPointsCountingElement = this.enabledLogos[CS___8__locals1.value];
			CS___8__locals1.flagText = endPointsCountingElement.flagsCounter.GetComponentInChildren<Text>();
			CS___8__locals1.flagText.text = "0";
			PlayerEndGameStats playerEndGameStats = this.stats.First((PlayerEndGameStats x) => x.player.matFaction.faction == CS___8__locals1.__4__this.enabledLogos[CS___8__locals1.value].faction);
			...
			{
				CS___8__locals1.flagText.text = num.ToString();
				for (int j = num - 1; j >= 0; j--)
				{
					...
					sequence.AppendCallback(delegate
					{
						CS___8__locals1.flagText.text = j1.ToString();
						CS___8__locals1.__4__this.AddPointsToScore(CS___8__locals1.i1, 1, true);
					});
					if (j == 0)
					{
						sequence.AppendInterval(this.restScoringLastHold);
		...
		// Token: 0x06001B91 RID: 7057 RVA: 0x000AEAD0 File Offset: 0x000ACCD0
		private void AnimateTrapsScoring()
		{
			PointsCountingPresenter.__c__DisplayClass74_0 CS___8__locals1 = new PointsCountingPresenter.__c__DisplayClass74_0();
			CS___8__locals1.__4__this = this;
			...
			for (i = 0; i < this.enabledLogos.Count; i = l + 1)
			{
				if (this.stats.First((PlayerEndGameStats x) => x.player.matFaction.faction == CS___8__locals1.__4__this.enabledLogos[i].faction).player.matFaction.faction == Faction.Togawa)
				{
					CS___8__locals1.value = i;
					break;
				}
			...
			CS___8__locals1.i1 = CS___8__locals1.value;
			EndPointsCountingElement endPointsCountingElement = this.enabledLogos[CS___8__locals1.value];
			CS___8__locals1.trapsText = endPointsCountingElement.trapsCounter.GetComponentInChildren<Text>();
			CS___8__locals1.trapsText.text = "0";
			this.stats.First((PlayerEndGameStats x) => x.player.matFaction.faction == CS___8__locals1.__4__this.enabledLogos[CS___8__locals1.value].faction);
			...
			CS___8__locals1.trapsText.text = num.ToString();
			for (int j = num - 1; j >= 0; j--)
			{
				sequence.AppendInterval((j == num) ? this.restScoringFirstHold : this.restScoringDelay);
				int j1 = j;
				sequence.AppendCallback(delegate
				{
					CS___8__locals1.trapsText.text = j1.ToString();
					CS___8__locals1.__4__this.AddPointsToScore(CS___8__locals1.i1, 1, true);
				});
				if (j == 0)
				{
		...
		// Token: 0x06001B92 RID: 7058 RVA: 0x000AEDAC File Offset: 0x000ACFAC
		private void AnimateEncountersScoring()
		{
			PointsCountingPresenter.__c__DisplayClass75_0 CS___8__locals1 = new PointsCountingPresenter.__c__DisplayClass75_0();
			CS___8__locals1.__4__this = this;
			...
			for (i = 0; i < this.enabledLogos.Count; i = l + 1)
			{
				if (this.stats.First((PlayerEndGameStats x) => x.player.matFaction.faction == CS___8__locals1.__4__this.enabledLogos[i].faction).player.matFaction.faction == Faction.Polania)
				{
					CS___8__locals1.value = i;
					break;
				}
			...
			CS___8__locals1.i1 = CS___8__locals1.value;
			EndPointsCountingElement endPointsCountingElement = this.enabledLogos[CS___8__locals1.value];
			CS___8__locals1.encountersText = endPointsCountingElement.encountersCounter.GetComponentInChildren<Text>();
			CS___8__locals1.encountersText.text = "0";
			this.stats.First((PlayerEndGameStats x) => x.player.matFaction.faction == CS___8__locals1.__4__this.enabledLogos[CS___8__locals1.value].faction);
			...
			CS___8__locals1.encountersText.text = num.ToString();
			for (int j = num - 1; j >= 0; j--)
			{
				sequence.AppendInterval((j == num) ? this.restScoringFirstHold : this.restScoringDelay);
				int j1 = j;
				sequence.AppendCallback(delegate
				{
					CS___8__locals1.encountersText.text = j1.ToString();
					CS___8__locals1.__4__this.AddPointsToScore(CS___8__locals1.i1, 1, true);
				});
				if (j == 0)
				{
		...
		// Token: 0x06001B93 RID: 7059 RVA: 0x000AF040 File Offset: 0x000AD240
		...
		// Token: 0x06001B94 RID: 7060 RVA: 0x000AF0D0 File Offset: 0x000AD2D0
		...
		// Token: 0x06001B95 RID: 7061 RVA: 0x00039DEB File Offset: 0x00037FEB
		...
		// Token: 0x06001B96 RID: 7062 RVA: 0x000AF26C File Offset: 0x000AD46C
		...
		// Token: 0x06001B97 RID: 7063 RVA: 0x000AF2E8 File Offset: 0x000AD4E8
		private void Update()
		{
		...
		// Token: 0x06001B98 RID: 7064 RVA: 0x000AF3E0 File Offset: 0x000AD5E0
		...
		// Token: 0x06001B99 RID: 7065 RVA: 0x000AF46C File Offset: 0x000AD66C
