...
namespace Scythe.UI
{
	...
	{
		// Token: 0x06001FFB RID: 8187 RVA: 0x0003C855 File Offset: 0x0003AA55
		private void Start()
		{
			this.SetFactionModelSkin();
		}

		// Token: 0x06001FFC RID: 8188 RVA: 0x000C30C0 File Offset: 0x000C12C0
		public void Init()
		{
			this.LinkUnits();
		...
		// Token: 0x06001FFD RID: 8189 RVA: 0x000C3124 File Offset: 0x000C1324
		...
		// Token: 0x06001FFE RID: 8190 RVA: 0x000C3238 File Offset: 0x000C1438
		...
		// Token: 0x06001FFF RID: 8191 RVA: 0x0003C85D File Offset: 0x0003AA5D
		...
		// Token: 0x06002000 RID: 8192 RVA: 0x000C338C File Offset: 0x000C158C
		...
		// Token: 0x06002001 RID: 8193 RVA: 0x000C33DC File Offset: 0x000C15DC
		...
		// Token: 0x06002002 RID: 8194 RVA: 0x000C3418 File Offset: 0x000C1618
		...
		// Token: 0x06002003 RID: 8195 RVA: 0x000C347C File Offset: 0x000C167C
		public void SetFactionModelSkin()
		{
			string name = base.gameObject.name;
			uint num = global::__PrivateImplementationDetails.ComputeStringHash(name);
			if (num <= 1313277548U)
			{
				if (num != 391982364U)
				{
