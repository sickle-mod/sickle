...
namespace Scythe.GameLogic
{
	...
	public class ActionLog : IXmlSerializable
	{
		...
		// (add) Token: 0x06002C03 RID: 11267 RVA: 0x000F4624 File Offset: 0x000F2824
		// (remove) Token: 0x06002C04 RID: 11268 RVA: 0x000F4658 File Offset: 0x000F2858
		public static event Action<LogInfo, int> LogInfoCreated;

		// Token: 0x06002C05 RID: 11269 RVA: 0x00044060 File Offset: 0x00042260
		public ActionLog(GameManager gameManager)
		{
			this.gameManager = gameManager;
		}

		// Token: 0x06002C06 RID: 11270 RVA: 0x00044090 File Offset: 0x00042290
		public void Clear()
		{
			this.lastTurn = 0;
		...
		// Token: 0x06002C07 RID: 11271 RVA: 0x000440BC File Offset: 0x000422BC
		...
		// Token: 0x06002C08 RID: 11272 RVA: 0x000440D4 File Offset: 0x000422D4
		public LogInfo GetLogInfo(int id)
		{
			return this.logInfoHistory[id];
		}

		// Token: 0x06002C09 RID: 11273 RVA: 0x000440E2 File Offset: 0x000422E2
		public int GetLogAmount()
		{
			return this.logInfoHistory.Count;
		}

		// Token: 0x06002C0A RID: 11274 RVA: 0x000440EF File Offset: 0x000422EF
		public List<LogInfo> GetLogHistory()
		{
			return this.logInfoHistory;
		}

		// Token: 0x06002C0B RID: 11275 RVA: 0x000440F7 File Offset: 0x000422F7
		public void RemoveLastLog()
		{
			this.logInfoHistory.RemoveAt(this.logInfoHistory.Count - 1);
		}

		// Token: 0x06002C0C RID: 11276 RVA: 0x000F468C File Offset: 0x000F288C
		...
		// Token: 0x06002C0E RID: 11278 RVA: 0x000F47E0 File Offset: 0x000F29E0
		...
		// Token: 0x06002C0F RID: 11279 RVA: 0x000F4850 File Offset: 0x000F2A50
		...
		// Token: 0x06002C10 RID: 11280 RVA: 0x00044111 File Offset: 0x00042311
		...
		// Token: 0x06002C11 RID: 11281 RVA: 0x00044140 File Offset: 0x00042340
		...
		// Token: 0x06002C12 RID: 11282 RVA: 0x000F48C8 File Offset: 0x000F2AC8
		...
		// Token: 0x06002C13 RID: 11283 RVA: 0x000F4964 File Offset: 0x000F2B64
		...
		// Token: 0x06002C14 RID: 11284 RVA: 0x000F49CC File Offset: 0x000F2BCC
		...
		// Token: 0x06002C15 RID: 11285 RVA: 0x000F4A80 File Offset: 0x000F2C80
		...
		// Token: 0x06002C16 RID: 11286 RVA: 0x000F4B34 File Offset: 0x000F2D34
		...
		// Token: 0x06002C17 RID: 11287 RVA: 0x000F4BA8 File Offset: 0x000F2DA8
		private void MergeEncounterLogs(LogInfo logInfo)
		{
			...
			{
				if (this.logInfoHistory[num].PayLogInfos == null)
				{
					this.logInfoHistory[num].PayLogInfos = new List<LogInfo>();
				}
				this.logInfoHistory[num].PayLogInfos.AddRange(logInfo.PayLogInfos);
			}
			...
			{
				this.logInfoHistory[num].AdditionalGain.AddRange(logInfo.AdditionalGain);
			}
			if (logInfo.PayLogInfos != null) logInfo.PayLogInfos.Clear();
			if (logInfo.AdditionalGain != null) logInfo.AdditionalGain.Clear();
		}

		// Token: 0x06002C18 RID: 11288 RVA: 0x000F4CC8 File Offset: 0x000F2EC8
		...
		// Token: 0x06002C19 RID: 11289 RVA: 0x000F4DE4 File Offset: 0x000F2FE4
		...
		// Token: 0x06002C1A RID: 11290 RVA: 0x000F4E78 File Offset: 0x000F3078
		...
		// Token: 0x06002C1B RID: 11291 RVA: 0x000F4FA4 File Offset: 0x000F31A4
		...
		// Token: 0x06002C1C RID: 11292 RVA: 0x00044167 File Offset: 0x00042367
		...
		// Token: 0x06002C1D RID: 11293 RVA: 0x000F4FFC File Offset: 0x000F31FC
		...
		// Token: 0x06002C1E RID: 11294 RVA: 0x000F5068 File Offset: 0x000F3268
		...
		// Token: 0x06002C1F RID: 11295 RVA: 0x000F519C File Offset: 0x000F339C
		...
		// Token: 0x06002C20 RID: 11296 RVA: 0x000F524C File Offset: 0x000F344C
		...
		// Token: 0x06002C21 RID: 11297 RVA: 0x00044191 File Offset: 0x00042391
		private LogInfo CreateEmptyEncounterActionLog(Faction playerAssigned)
		{
			return new GainNonboardResourceLogInfo(this.gameManager)
			{
				...
				IsEncounter = true,
				EncounterCardId = this.gameManager.LastEncounterCard != null ? this.gameManager.LastEncounterCard.CardId : 0,
		...
		// Token: 0x06002C23 RID: 11299 RVA: 0x000F52FC File Offset: 0x000F34FC
		...
		// Token: 0x06002C24 RID: 11300 RVA: 0x000F5494 File Offset: 0x000F3694
